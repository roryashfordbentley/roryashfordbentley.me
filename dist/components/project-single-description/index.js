...
var ProjectDescription = function (_React$Component) {
    _inherits(ProjectDescription, _React$Component);
    ...
    _createClass(ProjectDescription, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'wrapper' },
                _react2.default.createElement('div', { className: 'project-single__description', dangerouslySetInnerHTML: { __html: this.props.text } })
            );
        }
    }]);
